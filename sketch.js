...
function setup() {
	...
	bob1 = new Bob(240, 200, 40);
	bob2 = new Bob(320, 200, 40);
	bob3 = new Bob(400, 200, 40);
	bob4 = new Bob(480, 200, 40);
	bob5 = new Bob(560, 200, 40);
...
function draw() {
	...
	keyWork(bob2.body, bob3.body, bob4.body);

	if(keyDown(UP_ARROW)){
		Body.applyForce(bob1.body, bob1.body.position, {x: -1, y: 0});
	}
